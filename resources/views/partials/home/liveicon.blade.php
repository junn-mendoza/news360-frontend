<div class=" absolute bottom-0 left-1/4 translate-y-[-20px] translate-x-[-35px] z-[9999]">
    <div class='mt-10 p-3 w-20 h-20 sm:w-40 sm:h-40 text-red-600'>
        <svg viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg" stroke="#f00">
